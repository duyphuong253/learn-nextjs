...
export default function YTeTaiNhaPage() {
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <span>›</span>
            <span className="text-emerald-700 font-medium">Loại hình: y-te-tai-nha</span>
            </div>

            {/* Title */}
            <h1 className="text-4xl font-bold text-gray-900 mb-1">y-te-tai-nha</h1>
